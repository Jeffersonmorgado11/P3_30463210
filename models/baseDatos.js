...
const sql = `INSERT INTO productos(nombre, codigo, precio, descripcion, origen, capacidad , categoria_id) 
    VALUES (?, ?, ?, ?, ?, ? , ?)`;

db.run(sql, [nombre, codigo, precio, descripcion, origen, capacidad , categoria], err => {
    if (err) return console.error(err.message);
...
//-------------------------------------------
    ...
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
      ...
      description: 'Venta de Paneles Solares',
